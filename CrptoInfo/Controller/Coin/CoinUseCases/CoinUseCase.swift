...
extension CoinUseCase: CoinNetworkProvider {
    ...
    func fetchCoin(limit: Int, tsym: String, completion: @escaping (NetworkResult<[Coin]>) -> Void) {
        ...
        AF.request("https://min-api.cryptocompare.com/data/top/totaltoptiervolfull", method: .get, parameters: params, encoder: URLEncodedFormParameterEncoder.default, headers: nil, interceptor: nil, requestModifier: nil).responseJSON(completionHandler: { response in
